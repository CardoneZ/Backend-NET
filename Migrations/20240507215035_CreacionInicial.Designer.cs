...
namespace mvc.Migrations
{
    ...
    [Migration("20240507215035_CreacionInicial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend.Model.Pelicula", b =>
                {
            ...
            modelBuilder.Entity("CategoriaPelicula", b =>
                {
                    ...
                    b.HasKey("PeliculaId", "categoriasCategoriaId");
            ...
            modelBuilder.Entity("CategoriaPelicula", b =>
                {
                    b.HasOne("Backend.Model.Pelicula", null)
                        .WithMany()
                        .HasForeignKey("PeliculaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Backend.Model.Categoria", null)
                        .WithMany()
